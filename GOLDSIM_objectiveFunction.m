...
ic = [0.0001, 0.0003];
% mixtime = parameters(5);    %   quenching takes a little bit of time to take effect
mixtime=0;
[sol, mySettings] = GOLDSIM_simulateGoldParticles(parameters,model_reduction,ic, data.times(end)+mixtime);
...
%--------------------------------------------------------------------------
Cost = 0;
[sim_diams, sim_PSDs] = PBElib_getPSDs(sol,mySettings,data.times+mixtime);
